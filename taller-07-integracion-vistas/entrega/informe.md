...
| Seguridad            | Recoge los controles de identidad, protección de datos, monitoreo y cumplimiento normativo aplicados a toda la solución. | Tabla STRIDE, checklist normativo    | Protege al resto de vistas garantizando que procesos, datos, aplicaciones e infraestructura cumplan requisitos de confidencialidad, integridad y trazabilidad. |
